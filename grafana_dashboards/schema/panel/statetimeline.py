...
class StateTimeline(Base):
    ...
    options_config = {
        v.Optional("showValue"): v.Any("auto", "always", "never"),
    }
    ...
    def get_schema(self):
        ...
        state_timeline.update(self.base)

        return v.Schema(state_timeline, extra=v.PREVENT_EXTRA)
